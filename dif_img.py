...
x_lims_hi1, dt_hi1, delon_hi1, y_hi1, imsh_im_hi1, den_hi1, el_hi1 = hi_img(start, ftpsc, 'hi_1', 23)
x_lims_hi2, dt_hi2, delon_hi2, y_hi2, imsh_im_hi2, den_hi2, _ = hi_img(start, ftpsc, 'hi_2', el_hi1)

fig, ax = plt.subplots(figsize=(10,7))

ax.imshow(imsh_im_hi1, origin='lower', cmap='gray',
          extent=[x_lims_hi1[0]-dt_hi1/2, x_lims_hi1[-1]+dt_hi1/2, y_hi1[0]-delon_hi1/2, y_hi1[-1]+delon_hi1/2], aspect='auto')

ax.imshow(imsh_im_hi2, origin='lower', cmap='gray',
          extent=[x_lims_hi2[0]-dt_hi2/2, x_lims_hi2[-1]+dt_hi2/2, y_hi2[0]-delon_hi2/2, y_hi2[-1]+delon_hi2/2], aspect='auto')
