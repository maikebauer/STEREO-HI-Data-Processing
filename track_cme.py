...
#     if config['instrument'] =='hi1hi2':
#         savepath = config['output_directory'] + 'jplot/' + config['spacecraft'][num] + '/' + config['data_type'][num] + '/'

#         param_fil_h1 = glob.glob(savepath + 'hi_1/' + config['start_date'][num][0:4] + '/params/' + 'jplot_hi_1_' + config['start_date'][num] + '*' + config['data_type'][num][0] + jp_name + '_params.pkl')

#         param_fil_h1 = param_fil_h1[0]

#         param_fil_h2 = glob.glob(savepath + 'hi_2/' + config['start_date'][num][0:4] + '/params/' + 'jplot_hi_2_' + config['start_date'][num] + '*' + config['data_type'][num][0] + jp_name + '_params.pkl')
...
#         try:
#             file_h1 = glob.glob(savepath + 'hi_1/' + config['start_date'][num][0:4] + '/jplot_hi1_' + config['start_date'][num] + '_*_' + config['spacecraft'][num] + '_' + config['data_type'][num][0] + jp_name + '.pkl')[0]

#         except IndexError:
#             print('No file found under ' + savepath + 'hi_1/' + config['start_date'][num][0:4] + '/jplot_hi1_' + config['start_date'][num] + '_*_' + config['spacecraft'][num] + '_' + config['data_type'][num][0] + jp_name + '.pkl. Exiting...')
#             sys.exit()

#         try:
#             file_h2 = glob.glob(savepath + 'hi_2/' + config['start_date'][num][0:4] + '/jplot_hi2_' + config['start_date'][num] + '_*_' + config['spacecraft'][num] + '_' + config['data_type'][num][0] + jp_name + '.pkl')[0]

#         except IndexError:
#             print('No file found under ' + savepath + 'hi_2/' + config['start_date'][num][0:4] + '/jplot_hi2_' + config['start_date'][num] + '_*_' + config['spacecraft'][num] + '_' + config['data_type'][num][0] + jp_name + '.pkl. Exiting...')
#             sys.exit()
...
#         ax.set_title(config['start_date'][num] + ' STEREO-' + config['spacecraft'][num])
...
#         SC = [config['spacecraft'] for x in range(len(data[0]))]

#         pd_data = {'TRACK_DATE': date, 'ELON': elon, 'ELON_STDD': elon_stdd, 'SC': SC}

#         csv_path = savepath + '/hi1hi2/' + config['start_date'][num][0:4] + '/Tracks/' + config['start_date'][num] + '/'

#         if not os.path.exists(csv_path):
#             os.makedirs(csv_path)

#         prev_files = glob.glob(csv_path + config['start_date'][num] + '_' + config['data_type'][num][0] + '_' + config['spacecraft'][num] + '_track' + '_*.csv')
#         num_files = len(prev_files) + 1

#         df = pd.DataFrame(pd_data, columns=['TRACK_DATE', 'ELON', 'SC', 'ELON_STDD'])
#         df.to_csv(csv_path + config['start_date'][num] + '_' + config['data_type'][num][0] + '_' + config['spacecraft'][num] + '_track' + '_' + str(num_files) + '.csv', index=False, date_format='%Y-%m-%dT%H:%M:%S')
#         plt.close()
...
#         csv_path = savepath + '/hi_1/' + config['start_date'][num][0:4] + '/Tracks/' + config['start_date'][num] + '/'
...
#         csv_path = savepath + '/hi_2/' + config['start_date'][num][0:4] + '/Tracks/' + config['start_date'][num] + '/'
